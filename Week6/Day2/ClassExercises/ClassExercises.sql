...
-- Select everything from the table. (every row and columns) 
...
-- WHERE city = 'Boston' 
-- AND event_datetime BETWEEN '2015-03-01' AND '2015-03-05'
...
-- SELECT city, EXTRACT(Hour from event_datetime) AS hour_of_day FROM city_info 
